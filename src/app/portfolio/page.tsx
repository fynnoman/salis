    ...
    >
      ...
      <div className="relative w-full h-60 flex-shrink-0 overflow-hidden">
        ...
        <div className="absolute top-4 left-4 right-4 flex items-center justify-between z-10">
          ...
          <span className="text-white/60 text-xs font-mono bg-black/30 backdrop-blur-sm px-2 py-0.5 rounded-full">
            {project.year}
          </span>
        </div>
      </div>
    ...
    <main className="min-h-screen bg-[#0a0a0a]">
      ...
      <section className="relative overflow-hidden py-20 px-4 sm:px-6 lg:px-8">
        ...
        <div
          ...
          style={{ background: "radial-gradient(ellipse at center, #39ff14 0%, transparent 70%)" }}
        />
        <motion.div
          initial={{ opacity: 0, y: 30 }}
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <motion.a
              ...
              style={{ backgroundColor: "#39ff14", boxShadow: "0 0 28px #39ff1444" }}
